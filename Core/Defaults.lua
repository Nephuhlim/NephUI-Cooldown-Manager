    ...
    profile = {
        ...
        viewers = {
            general = {
                ...
                anchorToUnitFrame = false,
                anchorPositions = {
                    selectedFrame = "PlayerFrame",
                    -- Default positions for each frame type
        ...
        powerBar = {
            ...
            showManaPercentDecimal = true,
            showText          = true,
            showTicks         = true, 
            showFragmentedPowerBarText = false,
            textFormat        = "Current",
            textPrecision     = "0",
            fragmentedPowerBarTextPrecision = "0.0",
            smoothProgress    = true,
            fasterUpdates     = true,
            updateFrequency   = 0.1,
            textSize          = 20,
        ...
        qol = {
            ...
            autoInsertKey = true,
            sellJunk = true,
            autoRepair = "guildFirst", -- "off", "personal", "guildFirst"
            autoAcceptInvites = true, -- friends or guild only
