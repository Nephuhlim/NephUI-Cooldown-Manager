...
LSM:Register("statusbar","Neph", [[Interface\AddOns\NephUI Cooldown Manager\Media\Neph.tga]])
LSM:Register("font","Expressway", [[Interface\AddOns\NephUI Cooldown Manager\Fonts\Expressway.TTF]])

function NephUI:GetGlobalFont()
    local fontName = self.db.profile.general.globalFont or "Expressway"
    return LSM:Fetch("font", fontName) or [[Interface\AddOns\NephUI Cooldown Manager\Fonts\Expressway.TTF]]
end
